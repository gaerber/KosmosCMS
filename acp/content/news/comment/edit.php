<?php
 ...
 /*
 =====================================================
 Name ........: Plugin: Neuigkeiten Kommentare
 ...
 -----------------------------------------------------
 Beschreibung :
 Plugin: Bearbeiten von Kommentaren.
...
if (isset($_GET['id']) && is_numeric($_GET['id'])) {
	...
	if ($line = $result->fetch_assoc()) {
		...
		echo ActionReport(REPORT_EINGABE, "Kommentar existiert nicht",
				"Dieser Kommentar existiert in der Datenbank nicht!");
	}
}
else {
	/* Eingabefehler */
	echo ActionReport(REPORT_EINGABE, "Eingabefehler",
			"Es wurde kein Kommentar ausgewählt!");
}
