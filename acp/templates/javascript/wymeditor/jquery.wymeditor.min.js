...
/**
 * Import: plugins/table/jquery.wymeditor.table.js by swiss-webdesign
 *
...
/**
 * Import: plugins/embed/jquery.wymeditor.embed.js by swiss-webdesign
 *
...
/**
 * Customizing WYMeditor by swiss-webdesign.
 *
 * Important Needs the JQuery Library.
 * All new Styles must be inserted in wymiframe.css too.
 * The Skin - Default is a custom CSS file.
 */
jQuery(function() {
	jQuery('.wymeditor').wymeditor({
		...
		basePath: 'templates/javascript/wymeditor/',
		jQueryPath: 'templates/javascript/jquery/jquery1-7-2.js',
		...
		toolsItems:[
			...
			{name:"CreateLink",title:"Link",css:"wym_tools_link wym_opens_dialog"},
			{name:"Unlink",title:"Unlink",css:"wym_tools_unlink"},
			{name:"InsertImage",title:"Image",css:"wym_tools_image wym_opens_dialog"},
			{name:"InsertTable",title:"Table",css:"wym_tools_table wym_opens_dialog"},
			{name:"ToggleHtml",title:"HTML",css:"wym_tools_html"},
			{name:"Preview",title:"Preview",css:"wym_tools_preview wym_opens_dialog"}
		],

		classesItems: [
			{'name': 'content-img-center', 'title': 'Bild: Zentriert', 'expr': 'img'},
			{'name': 'content-img-right', 'title': 'Bild: Rechts, Textumfliessend', 'expr': 'img[@class!="content-img-left"]'},
			{'name': 'content-img-left', 'title': 'Bild: Links, Textumfliessend', 'expr': 'img[@class!="content-img-right"]'},
			{'name': 'content-img-border', 'title': 'Bild: Rahmen', 'expr': 'img'}
		],
		...
		// Important: Patch to make the preview resizable

		dialogHtml: "<!DOCTYPE html PUBLIC '-//W3C//DTD XHTML 1.0 Strict//EN'"
			+ " 'http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd'>"
			+ "<html dir='"+WYMeditor.DIRECTION+"'><head>"
			+ "<link rel='stylesheet' type='text/css' href='templates/stylesheets/wymeditor-popup.css' />"
			+ "<link rel='stylesheet' type='text/css' href='../templates/stylesheets/content.css' />"
			+ "<title>"+WYMeditor.DIALOG_TITLE+"</title>"
			+ "</head>"
			+ WYMeditor.DIALOG_BODY
			+ "</html>",

		dialogLinkHtml:  "<body class='wym_dialog wym_dialog_insert wym_dialog_link'"
			+ " onload='window.frames[0].document.getElementById(\"form_1\").value = document.getElementById(\"wym_href\").value;'>"
			+ "<h1 class='form_hide'>{Link}</h1>"
			+ "<form class='form_acp_standard form_hide' accept-charset='utf-8'><ol>"
			+ "<input type='hidden' class='wym_dialog_type' value='"+ WYMeditor.DIALOG_LINK+"' />"
			+ "<li class='obligation'>"
			+ "  <label class='line' for='wym_href'>{URL}</label>"
			+ "  <input type='text' id='wym_href' class='wym_href input_text' value='http://' />"
			+ "</li>"
			+ "<input type='hidden' class='wym_title' />"

			+ "<li><label class='line_hide'></label>"
			+ "  <input id='wym_submit' class='wym_submit input_btn' type='submit' value='{Submit}' />"
			+ "  <input class='wym_cancel input_btn' type='button' value='{Cancel}' />"
			+ "</li>"
			+ "</ol></form>"
			+"<iframe src='frame.php?page=wymeditor-links-default' name='myiframe' frameborder='0'></iframe>"
			+ "</body>",

		dialogImageHtml:  "<body class='wym_dialog wym_dialog_insert wym_dialog_image'"
			+ " onload='window.frames[0].document.getElementById(\"form_1\").value = document.getElementById(\"wym_src\").value;'>"
			+ "<h1 class='form_hide'>{Image}</h1>"
			+ "<form class='form_acp_standard form_hide' accept-charset='utf-8'><ol>"
			+ "<input type='hidden' class='wym_dialog_type' value='"+ WYMeditor.DIALOG_IMAGE+"' />"
			+ "<li class='obligation'>"
			+ "  <label class='line' for='wym_src'>{URL}</label>"
			+ "  <input type='text' id='wym_src' class='wym_src input_text' />"
			+ "</li>"
			+ "<li>"
			+ "  <label class='line' for='wym_alt'>{Alternative_Text}</label>"
			+ "  <input type='text' id='wym_alt' class='wym_alt input_text' />"
			+ "</li>"
			+ "<input type='hidden' class='wym_title' />"
			+ "<li><label class='line_hide'></label>"
			+ "  <input id='wym_submit' class='wym_submit input_btn' type='submit' value='{Submit}' />"
			...
			+ "</li>"
			+ "</ol></form>"
			+"<iframe src='frame.php?page=wymeditor-images-default' name='myiframe' frameborder='0'></iframe>"
			+ "</body>",

		dialogTableHtml:  "<body id='table-view' class='wym_dialog wym_dialog_insert wym_dialog_table'>"
			+ "<h1>{Table}</h1>"
			+ "<form class='form_acp_standard' accept-charset='utf-8'><ol>"
			+ "<input type='hidden' class='wym_dialog_type' value='"+WYMeditor.DIALOG_TABLE+"' />"
			+ "<li>"
			+ "  <label class='line' for='wym_caption'>{Caption}</label>"
			+ "  <input type='text' id='wym_caption' class='wym_caption input_text' />"
			+ "</li>"
			+ "<li>"
			+ "  <label class='line' for='wym_summary'>{Summary}</label>"
			+ "  <input type='text' id='wym_summary' class='wym_summary input_text' />"
			+ "</li>"
			+ "<li class='obligation'>"
			+ "  <label class='line' for='wym_rows'>{Number_Of_Rows}</label>"
			+ "  <input type='text' id='wym_rows' class='wym_rows input_text' value='3' />"
			+ "</li>"
			+ "<li class='obligation'>"
			+ "  <label class='line' for='wym_cols'>{Number_Of_Cols}</label>"
			+ "  <input type='text' id='wym_cols' class='wym_cols input_text' value='2' />"
			+ "</li>"
			+ "<li><label class='line_hide'></label>"
			+ "  <input id='wym_submit' class='wym_submit input_btn' type='submit' value='{Submit}' />"
			+ "  <input class='wym_cancel input_btn' type='button' value='{Cancel}' />"
		...
		// Bug: Body tag missing in preview!
		//dialogPreviewHtml: '<body id="content" class="wym_dialog wym_dialog_preview"></body>',
		postInitDialog: function(wym, wdw) {
			if (wdw.document.body.id != 'table-view') {
				wdw.document.body.id = 'content';
			}
		},
