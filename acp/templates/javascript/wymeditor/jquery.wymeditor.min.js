...
/**
 * Import: plugins/embed/jquery.wymeditor.embed.js by Kevin Gerber
 *
...
jQuery(function() {
	jQuery('.wymeditor').wymeditor({
		...
		dialogFeaturesPreview: "menubar=no,titlebar=no,toolbar=no,resizable=yes"
			+ ",scrollbars=yes,width=580,height=320",

		dialogHtml: "<!DOCTYPE html PUBLIC '-//W3C//DTD XHTML 1.0 Strict//EN'"
			+ " 'http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd'>"
			+ "<html dir='"+WYMeditor.DIRECTION+"'><head>"
			+ "<link rel='stylesheet' type='text/css' href='templates/stylesheets/wymeditor_popup.css' />"
		...
		dialogLinkHtml:  "<body class='wym_dialog wym_dialog_insert wym_dialog_link'"
			+ " onload='WYMeditor.INIT_DIALOG("+WYMeditor.INDEX+"); window.frames[0].document.getElementById(\"form_1\").value = document.getElementById(\"wym_href\").value;'>"
		...
		dialogImageHtml:  "<body class='wym_dialog wym_dialog_insert wym_dialog_image'"
			+ " onload='WYMeditor.INIT_DIALOG("+WYMeditor.INDEX+"); window.frames[0].document.getElementById(\"form_1\").value = document.getElementById(\"wym_src\").value;'>"
		...
		dialogTableHtml:  "<body class='wym_dialog wym_dialog_insert wym_dialog_table'"
		...
		dialogPreviewHtml: '<body id="content" class="wym_dialog wym_dialog_preview" '
